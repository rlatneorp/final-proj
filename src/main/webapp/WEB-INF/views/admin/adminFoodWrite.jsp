...
<br>
	...
	<form id="foodInsertForm" action="${contextPath}/adminFoodInsert.ad" method="post" enctype="multipart/form-data">
		<main id="order-wrap">
			<!-- 구매창 컨테이너 -->
			<div class="left">
				<!-- 구매창 왼쪽 사진 넣는 곳 -->
...
<!-- 						밀키트/식재료 여부 -->
		...
		<div class ="productInfoMain">
			...
			<div id="target">
				...
				<ul>
					<li><input type="text" name="foodTarget" class="adminInput" placeholder="식단 관리가 필요하신 분!" style="margin-bottom:3px; font-size: 16px; width: 100%;"></li>
					<li><input type="text" name="foodTarget" class="adminInput" placeholder="몸 관리가 필요하신 분!" style="margin-bottom:3px; font-size: 16px; width: 100%;"></li>
					<li><input type="text" name="foodTarget" class="adminInput" placeholder="마음 관리가 필요하신 분!" style="margin-bottom:3px; font-size: 16px; width: 100%;"></li>
				</ul>
			</div>
			...
			<div id="order">
							...
							<table class="mb-3 w-100">
								<tr>
									...
									<td style="width: 30%;">
										...
										<div style="width: 360px; " class="d-flex justify-content-center">
											<img class="previewImage" src="${contextPath}/resources/images/logo_360x270.png" width="360" height="270" class="d-flex">
										</div>
										<input name="imageFile" type="file" accept=".png, .jpg, .jpeg">
										<p style="font-size: 12px; color: gray; margin-bottom: 0px;">최적 이미지 비율은 4:3입니다.</p>
				...
				<div class="d-flex justify-content-center mb-5">
					<div class="d-flex">
						<button onclick="submitFood()" type="button" class="me-4" style="background-color: #19A7CE; color: white; border-radius: 10px; box-shadow: 2px 2px 3px 0px gray; width: 100px; height: 40px; font-size: 14px; font-weight: bold;">작성하기</button>
				...
				if(textYN == "Y" && imageYN == "Y"){
					if(productPrice.value == 0){
						if(!confirm("가격을 0원으로 설정하시겠습니까?")){
							...
							document.getElementById('foodInsertForm').submit();
						}
					}else{
						document.getElementById('foodInsertForm').submit();
					}
