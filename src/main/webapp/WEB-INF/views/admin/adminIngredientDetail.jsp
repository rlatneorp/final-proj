		...
		<form action="${contextPath}/adminIngredientUpdate.ad" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col-6 row">
					...
					<textarea rows="10" name="ingredientContent" class="col-9 mb-2 rounded" placeholder="재료 내용을 입력해주세요.">${igd.ingredientContent}</textarea>
					
					<span class="col-3 mb-3">공식등록</span>
					<input type="hidden" name="isAccept" value="${igd.isAccept}">
