	...
	<div class="d-inline-block align-top mt-5 p-4 ps-5 rounded" style="width: 900px; height:1000px; border: 2px solid rgba(0,0,0,0.1);">
		...
		<div class="row">
			...
			<div class="d-flex justify-content-center pt-5">
				<button class="rounded me-4" onclick="location.href='${contextPath}/adminMemberEdit.ad?page='" style="width: 100px; height:40px; border: 2px solid rgba(0,0,0,0.1); background:white; color: rgba(0,0,0,0.8);">수정하기</button>
				<button class="rounded" onclick="location.href='${contextPath}/adminMemberManage.ad?page='" style="width: 100px; height:40px; border: 2px solid rgba(0,0,0,0.1); background:white; color: rgba(0,0,0,0.8);">뒤로가기</button>
			</div>
		</div>
	</div>
