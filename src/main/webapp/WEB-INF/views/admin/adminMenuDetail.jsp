...
/* 	식단 소개 */
	#top{width: 1200px; height: 600px; position: relative; display: inline-block;}
...
<body>
	...
	<div id="order">
		<div id="orderList">
			...
			<c:forEach begin="1" end="7" varStatus="vs">
				<table id="menuTable" class="mb-3">
					<tr>
						...
						<td class="image">
							<img src="resources/image/mudo.png" width="150px" height="120px" alt="메인메뉴사진">
						</td>
					...
					<tr>
						<td class="image">
							<img src="resources/image/mudo.png" width="150px" height="120px" alt="서브메뉴1사진">
						</td>
						<td class="content align-top p-3">
					...
					<tr>
						<td class="image">
							<img src="resources/image/mudo.png" width="150px" height="120px" alt="서브메뉴2사진">
						</td>
						<td class="content align-top p-3">
					...
					<tr>
						<td class="image">
							<img src="resources/image/mudo.png" width="150px" height="120px" alt="서브메뉴3사진">
						</td>
						<td class="content align-top p-3">
			...
			<p style="font-size: 24px; font-weight: bold; text-align: right;">총계</p>
			<p style="font-size: 22px; font-weight: bold; text-align: right;">65,800원</p>
