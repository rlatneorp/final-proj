...
<!-- 				</span> -->
			...
			<div class="d-flex justify-content-center pt-5">
				<button class="rounded me-4" onclick="location.href='${contextPath}/adminMenuEdit.ad?page='" style="width: 100px; height:40px; border: 2px solid rgba(0,0,0,0.1); background:white; color: rgba(0,0,0,0.8);">수정하기</button>
				<button class="rounded" onclick="location.href='${contextPath}/adminMenuManage.ad?page='" style="width: 100px; height:40px; border: 2px solid rgba(0,0,0,0.1); background:white; color: rgba(0,0,0,0.8);">뒤로가기</button>
			</div>
		</div>
	</div>
