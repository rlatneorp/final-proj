...
<body>
	...
	<div class="mainBox">
		...
		<div class="d-flex justify-content-center mb-5">
					<div class="d-flex">
						<button onclick="location.href='${contextPath}/adminMenuUpdate.ad'" class="me-4" style="background-color: #19A7CE; color: white; border-radius: 10px; box-shadow: 2px 2px 3px 0px gray; width: 100px; height: 40px; font-size: 14px; font-weight: bold;">수정하기</button>
