...
<body>
	...
	<div class="mainBox">
		<div id="top" style="margin-bottom:120px;">
			...
			<div id="imformation">
				<div id="title">
					<input type="text" name="title" style="font-size: 20px; width: 250px; margin-right: 340px;" placeholder="식단 이름을 적어주세요." readonly>
				...
				<div id="userInfo">
					...
					<p>*****(별점)</p>
					<textarea name="subContent" rows="6" cols="80" placeholder="식단에 대한 설명을 입력해주세요." readonly></textarea>
				</div>
			</div>
		</div>
			...
			<table class="w-100 text-center mb-3 border-none" style="border-top: 3px solid rgba(0,0,0,0.2); border-bottom: 3px solid rgba(0,0,0,0.2);">
				...
				<c:forEach begin="1" end="4" varStatus="vs">
					<tr style="border-bottom: 1px solid rgba(0,0,0,0.2);">
						<td>${11-vs.index}</td>
						<td>일주일밖에 안먹었지만 건강해진 느낌이에요!${11-vs.index}</td>
		...
		<div class="d-flex justify-content-center mb-5" style="width:1200px;">
			<div class="d-flex">
				<button onclick="location.href='${contextPath}/adminMenuReviewManage.ad'" type="button" style="background-color: #19A7CE; color: white; border-radius: 10px; box-shadow: 2px 2px 3px 0px gray; width: 100px; height: 40px; font-size: 14px; font-weight: bold;">뒤로가기</button>
			</div>
		</div>
	</div>
	<br><br><br><br>
