...
<body>
	...
	<div class="mainBox">
		<div id="top" style="margin-bottom:120px;">
			...
			<div id="imformation">
				<div id="title">
					<input type="text" name="title" style="font-size: 20px; width: 250px; margin-right: 340px;" placeholder="상품 이름을 적어주세요." readonly>
				...
				<br><br><br><br><br>
				<textarea name="subContent" rows="6" cols="80" placeholder="상품에 대한 설명을 입력해주세요." readonly></textarea>
			</div>
		</div>
		...
		<div class="d-flex justify-content-center mb-5" style="width:1200px;">
			<div class="d-flex">
				<button onclick="location.href='${contextPath}/adminProductReviewManage.ad'" type="button" style="background-color: #19A7CE; color: white; border-radius: 10px; box-shadow: 2px 2px 3px 0px gray; width: 100px; height: 40px; font-size: 14px; font-weight: bold;">뒤로가기</button>
			</div>
		</div>
	</div>
	<br><br><br><br>
