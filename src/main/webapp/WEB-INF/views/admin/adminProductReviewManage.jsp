...
<body>
	...
	<div class="mainBox d-inline-block align-top">
		<h4 class="py-4 mb-0">상품구매 후기 관리</h4>
		...
		<table class="w-100 text-center mb-3">
			...
			<c:forEach begin="1" end="10" varStatus="vs">
				<tr style="border-bottom: 1px solid rgba(0,0,0,0.2);">
					...
					<td>
						<a href="${contextPath}/adminProductReviewDetail.ad?page=${pi.currentPage}&productReviewNo=">
							사용하기 편하고 보관도 편해요!${11-vs.index}</a>
					</td>
					<td>(${11-vs.index})-도마세트${11-vs.index}</td>
					<td>
