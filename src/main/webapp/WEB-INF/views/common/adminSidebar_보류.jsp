...
<!-- 	<div class="d-flex position-fixed sidebar" style="width: 230px; z-index: 2000;"> -->
	<div class="d-flex position-fixed sidebar" style="width: 230px; z-index: 2000; top: 40px;">
		<div class="d-flex flex-column p-3 bg-white">
			...
			<div class="folder">
				<ul class="list-unstyled ps-0">
					<li class="mb-1">
						<button class="btn d-inline-flex align-items-center rounded border-0 collapsed" data-bs-target="#collapse-one" aria-expanded="true">
							매출관리
						</button>
						<div>
<!-- 							<ul class="list-unstyled fw-normal pb-1 small"> -->
					...
					<li class="mb-1">
						<button class="btn d-inline-flex align-items-center rounded border-0 collapsed" data-bs-target="#collapse-two" aria-expanded="true">
							회원관리
						</button>
						<div>
							<ul class="list-unstyled fw-normal pb-1 small">
	...
	<!-- 							<li><a href="#" class="link-dark d-inline-flex text-decoration-none rounded">출석체크관리</a></li> -->
					...
					<li class="mb-1">
						<button class="btn d-inline-flex align-items-center rounded border-0 collapsed" data-bs-target="#collapse-three" aria-expanded="true">
							상품관리
						</button>
						<div>
							<ul class="list-unstyled fw-normal pb-1 small">
					...
					<li class="mb-1">
						<button class="btn d-inline-flex align-items-center rounded border-0 collapsed" data-bs-target="#collapse-four" aria-expanded="true">
							게시글관리
						</button>
						<div>
							<ul class="list-unstyled fw-normal pb-1 small">
					...
					<li class="mb-1">
						<button class="btn d-inline-flex align-items-center rounded border-0 collapsed" data-bs-target="#collapse-five" aria-expanded="true">
							고객센터
						</button>
						<div>
							<ul class="list-unstyled fw-normal pb-1 small">
