				...
				<div class="carousel-item active">
					<div class="mainFood2"  style="display: flex; justify-content: center;">
						<c:forEach items="${ likeOrderByOne }" var="li" end="3">
							<div style="cursor:pointer; margin: 7px; width: 230px; height: 380px;" onclick="window.location.href='${contextPath}/market_detail.ma?productNo=${li.productNo }'" >
								<div class="img-div"> 
									<img src="${ contextPath }/resources/uploadFiles/${ li.productImg }" class="rounded recipe-img">
								</div>
								<c:if test="${li.productName ne null }">
									<div class="recipe-name">${ li.productName }</div>
								</c:if>
