...
/* 	#preview{width: 300px; height: 300px; position: absolute;  border-radius: 2em; border:3px solid #B0DAFF; top: 0;} */
...
<!-- 				</span> -->
				<img id="preview" src="${contextPath}/resources/uploadFiles/${thum.imageRenameName}" style="width:300px; height:300px; border-radius: 2em; border:3px solid #B0DAFF; position: absolute;">		
						...
						<div class="recipeBox">
							...
							<div class="d-inline-block recipeImage">
								<div class="d-inline-block recipeImg">
									...
									<input type="file" accept="image/*" class="form-control form-control-lg" name="orderFile" onchange="orderImage(this)" value="${oList.recipeOriginalName}">
...
function orderPlus(){
	if(count < 10){
		...
		document.querySelectorAll('.copyC')[document.querySelectorAll('.copyC').length -1].childNodes[1].childNodes[5].childNodes[1].childNodes[1].style.visibility="visible";
// 		console.log(document.querySelectorAll('.copyC')[document.querySelectorAll('.copyC').length -1].childNodes[1].childNodes[5].childNodes[1].childNodes[1]);
